// This is the implementation of variants of the 5term and slice-update scheme
// in which
...
vector<double> ehvi3d_5term(deque<individual*> P, double r[],
    vector<mus*>& pdf)
{
    // 5-term 3-dimensional ehvi calculation scheme. Subtracts 4 quantities off a
    // rectangular volume.
...
vector<double> ehvi3d_sliceupdate(deque<individual*> P, double r[DIMENSIONS],
    vector<mus*>& pdf)
{
    // Slice-update scheme.
    vector<double> answer; // The eventual answer.
