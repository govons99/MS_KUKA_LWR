...
int main(int argc, char *argv[])
{
	...
	printf("Starting the program LWRJointPositionControlExample \n");

	//To be set with relative PATH
	
	Robot	=	new LWRJointPositionController("/home/kuka_linux/Desktop/Corl/Controller_MEMPC/external/FRILibrary/etc/980039-FRI-Driver.init");
