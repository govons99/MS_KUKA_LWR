...
int main(int argc, char *argv[])
{
	...
	Robot	=	new LWRJointImpedanceController("/home/kuka_linux/Desktop/Corl/Controller_MEMPC/external/FRILibrary/etc/980039-FRI-Driver.init");

	fprintf(stdout, "RobotJointImpedanceController object created. Starting the robot...\n");

	for (i = 0; i < NUMBER_OF_JOINTS; i++)
	{
		CommandedStiffness	[i]	=	(float)0.0;
		CommandedDamping	[i]	=	(float)0.0;
