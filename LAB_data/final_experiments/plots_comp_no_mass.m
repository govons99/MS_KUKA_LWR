...
error_dar = load("./tau=2/no_mass/error.txt");
error_dar = load("./tau=4/error.txt");
error_smc = load("./SMC_no_matched/no_mass/error.txt");
error_fbl = load("./FBL_no_matched/no_mass/error.txt");

q_dar = load("./tau=2/no_mass/Q.txt");
q_dar = load("./tau=4/Q.txt");
q_smc = load("./SMC_no_matched/no_mass/Q.txt");

q = load("./FBL_no_matched/no_mass/Q.txt");
dq_hat = load("./FBL_no_matched/no_mass/dQ_hat.txt");
...
control_dar = load("./tau=2/no_mass/control_DAR.txt");
control_dar = load("./tau=4/control_DAR.txt");
control_smc = load("./SMC_no_matched/no_mass/control.txt");
