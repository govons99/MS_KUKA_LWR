...
for i = 1:max(size(q))
    ...
    control(:,i) = Mass_2R*( ref_ddot(:,i) + P_Gain * (ref(:,i) - [q(i,2);q(i,4)]) + D_Gain * (ref_dot(:,i) - [dq_hat(i,2);dq_hat(i,4)])) + Coriolis_2R + Gravity_2R;
...
%title('control')
saveas(gcf,'control_FBL.eps','epsc')
